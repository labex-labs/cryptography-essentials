...
<p align="center">
  <a href="https://labex.io/pt/courses/cryptography-essentials">
    <img src="https://course-cover.labex.io/cryptography-essentials.png?lang=pt" alt="Fundamentos de Criptografia">
  </a>
</p>
...
[Iniciar curso no LabEx](https://labex.io/pt/courses/cryptography-essentials)

## Exercícios

|   Índice | Nome                                  | Dificuldade   | Prática                                                                                                                                                  |
|----------|---------------------------------------|---------------|----------------------------------------------------------------------------------------------------------------------------------------------------------|
|        1 | Codificação vs. Criptografia          | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-encoding-vs-encryption-656187?course=cryptography-essentials'>Iniciar Lab</a>                    |
|        2 | Conceitos de Hashing Criptográfico    | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-cryptographic-hashing-concepts-656186?course=cryptography-essentials'>Iniciar Lab</a>            |
|        3 | Criptografia Simétrica e Assimétrica  | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-symmetric-and-asymmetric-encryption-656189?course=cryptography-essentials'>Iniciar Lab</a>       |
|        4 | Identificação de Tipos de Hash        | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-identifying-hash-types-656188?course=cryptography-essentials'>Iniciar Lab</a>                    |
|        5 | Desafio de Investigação Criptográfica | Intermediário | <a target='_blank' href='https://labex.io/pt/labs/linux-cryptographic-investigation-challenge-656185?course=cryptography-essentials'>Iniciar Desafio</a> |
